...
local command_lookups = {
  ...
  ObsidianLinkFromTemplate = "obsidian.commands.link_from_template",
...
M.register("ObsidianLinkFromTemplate", { opts = { nargs = "?", desc = "Insert a new note Link from a template" } })
